...
import java.util.Scanner;
    ...
    static int habilidadesFinal() {
        ...
        System.out.println("1 - Mutilar: Anna empunha duas lâmina curta e faz cortes bem profundos no inimigo");
...
class HalrocFinal {
    ...
    public static int habilidadesFinal() {
        Scanner input = new Scanner(System.in);
        System.out.println("~~ HABILIDADES ~~");
        System.out.println("1 - Corte Supersonico: Aparece nas costas do oponente em super velocidade, cortando-o multipla vezes rapidamente e voltando a sua posição");
        System.out.println("2 - Corte das Trevas: Faz diversos cortes no ar, interligando-o a um inimigo e o acertando diversas vezes");
        System.out.println("3 - Surpresa em dobro!!: Lança um kit de bombas a longa distancia  no rosto de um inimigo");
        return input.nextInt();
    }
}
...
class YruanFinal {
    ...
    public static int habilidadesFinal() {
        ...
        System.out.println("3 - Invisível: Infunde seu corpo com energia e fica tão rápido a ponto de seu inimigo não o ver, e vai até o inimigo golpeá-lo.");
        return input.nextInt();
    }
}
